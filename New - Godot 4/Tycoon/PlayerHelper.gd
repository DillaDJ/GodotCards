...
var player_scn := preload("TycoonPlayer.tscn")

var players : Array[TycoonPlayer] = []
...
# Helpers
func get_player_from_owner_id(id) -> TycoonPlayer:
...
func get_players() -> Array[TycoonPlayer]:
	return players
